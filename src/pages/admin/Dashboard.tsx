                    ...
                    .map(renewal => (
                      <div key={renewal.id} className="flex items-center justify-between group hover:bg-warning/5 p-2 rounded-lg transition-colors">
                        <div className="flex items-center">
                          ...
                          <div>
                            <p className="font-medium group-hover:text-warning transition-colors">{renewal.service_name}</p>
      ...
      {selectedRenewal && (
        <Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}>
          <DialogContent className="colorful-popup sm:max-w-[550px]">
            <DialogHeader>
              <DialogTitle className="text-xl text-primary">{selectedRenewal.service_name}</DialogTitle>
            </DialogHeader>
            
            <div className="grid grid-cols-2 gap-5 py-4">
              <div className="bg-primary/5 p-3 rounded-lg">
                <h4 className="text-sm font-medium text-primary mb-1">Service Type</h4>
                <p className="capitalize">{selectedRenewal.service_type}</p>
              </div>
              <div className="bg-secondary/5 p-3 rounded-lg">
                <h4 className="text-sm font-medium text-secondary mb-1">Provider</h4>
                <p>{selectedRenewal.provider}</p>
              </div>
